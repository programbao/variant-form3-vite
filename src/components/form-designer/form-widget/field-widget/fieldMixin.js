...
export default {
  inject: ["refList", "getFormConfig", "globalOptionData", "globalModel", "getOptionData", "getGlobalDsv", "getReadMode", "getSubFormFieldFlag", "getSubFormName", "getDSResultCache", "getObjectFieldFlag", "getObjectName"],
    data() {
        return {
            fieldReadonlyFlag: !1,
            dataSetLoadedFlag: !1
    ...
    computed: {
        ...
        isReadMode() {
            return this.getReadMode() ? !0 : this.fieldReadonlyFlag
        },
        optionLabel() {
            ...
            {
                let e = "--";
                return this.field.options.optionItems.forEach(o=>{
                    (o.value === this.fieldModel || this.findInArray(this.fieldModel, o.value) !== -1 || o.value === this.fieldModel.value || this.findInArray(this.fieldModel.value, o.value) !== -1) && (e = e === "--" ? o.label : e + " " + o.label)
                }
                ),
                e
            }
    ...
    methods: {
        ...
        getPropName() {
            return this.subFormItemFlag && !this.designState ? this.subFormName + "." + this.subFormRowIndex + "." + this.fieldKeyName : this.getObjectFieldFlag() && !this.designState ? this.getObjectName() + "." + this.fieldKeyName : this.fieldKeyName
        },
        getObjectModel() {
            let e = this.getObjectName().split(".")
              , o = this.formModel;
            return e.forEach(t=>{
                !t || (o[t] === void 0 && (o[t] = {}),
                o = o[t])
        ...
        initFieldModel() {
            if (!!this.field.formItemFlag) {
                if (!!this.getObjectFieldFlag() && !this.designState) {
                    ...
                    this.fieldModel = e === void 0 ? null : e[this.fieldKeyName],
                ...
                if (!!this.subFormItemFlag && !this.designState) {
                    ...
                    (e === void 0 || e[this.subFormRowIndex] === void 0 || e[this.subFormRowIndex][this.fieldKeyName] === void 0) && this.field.options.defaultValue !== void 0 ? (this.fieldModel = this.field.options.defaultValue,
                    e[this.subFormRowIndex][this.fieldKeyName] = this.field.options.defaultValue) : e[this.subFormRowIndex][this.fieldKeyName] === void 0 ? (this.fieldModel = null,
                    e[this.subFormRowIndex][this.fieldKeyName] = null) : this.fieldModel = e[this.subFormRowIndex][this.fieldKeyName],
                    setTimeout(()=>{
                        this.handleOnChangeForSubForm(this.fieldModel, this.oldFieldValue, e, this.subFormRowId)
                    }
                    , 800),
                    this.oldFieldValue = deepClone(this.fieldModel),
                    this.initFileList();
                ...
                this.formModel[this.fieldKeyName] === void 0 && this.field.options.defaultValue !== void 0 ? this.fieldModel = this.field.options.defaultValue : this.formModel[this.fieldKeyName] === void 0 ? this.formModel[this.fieldKeyName] = null : this.fieldModel = this.formModel[this.fieldKeyName],
                this.oldFieldValue = deepClone(this.fieldModel),
                this.initFileList()
            }
        },
        ...
        initEventHandler() {
            this.designState || (this.on$("setFormData", e=>{
                if (!this.subFormItemFlag)
                    if (!!this.getObjectFieldFlag() && !this.designState) {
                        const o = this.getObjectModel();
                        this.setValue(o === void 0 ? null : o[this.fieldKeyName])
                    } else
                        this.setValue(e[this.fieldKeyName])
            }
            ),
            this.on$("field-value-changed", e=>{
                if (this.subFormItemFlag) {
                    let o = this.formModel[this.subFormName];
                    this.handleOnChangeForSubForm(e[0], e[1], o, this.subFormRowId)
                } else
                    this.handleOnChange(e[0], e[1])
            }
            ),
            this.on$("sync-field-value", e=>{
                const o = e[0]
                  , t = e[1];
                if (this.field.options.name === o || !t && this.field.options.keyName !== o || !this.field.options.keyName && this.field.options.name !== t || !!this.field.options.keyName && !!t && this.field.options.keyName !== t || e[5] !== this.getObjectName())
                    return;
                const n = e[2]
                  , l = e[3]
                  , i = e[4];
                !this.subFormName && !n ? this.setValue(i, !0) : this.subFormName === n && this.subFormRowId === l && this.setValue(i, !0)
            }
            ),
            this.on$("calculate-formula", e=>{
                if (!!this.field.options.formulaEnabled && !!this.field.options.formula) {
                    let o = e[1];
                    const t = e[1].field.options.name;
                    fieldIsUsedInFormula(t, this.field.options.formula, this.getFormRef()) && calculateFormula(this.getFormRef(), this.getGlobalDsv(), formulajs, this, o)
                }
            }
            ),
            this.on$("loadOptionItemsFromDataSet", e=>{
                this.loadOptionItemsFromDataSet(e),
        ...
        handleOnCreated() {
            this.designState || this.field.options.onCreated && new Function(this.field.options.onCreated).call(this)
        },
        handleOnMounted() {
            this.designState || this.field.options.onMounted && new Function(this.field.options.onMounted).call(this)
        },
        registerToRefList(e) {
            this.refList !== null && !!this.field.options.name && (this.subFormItemFlag && !this.designState ? (e && delete this.refList[e + "@row" + this.subFormRowId],
            this.refList[this.field.options.name + "@row" + this.subFormRowId] = this) : (e && delete this.refList[e],
            this.refList[this.field.options.name] = this))
        },
        unregisterFromRefList() {
            if (this.refList !== null && !!this.field.options.name) {
                let e = this.field.options.name;
                this.subFormItemFlag && !this.designState ? delete this.refList[e + "@row" + this.subFormRowId] : delete this.refList[e]
            }
        },
        async initOptionItems(e) {
            if (!this.designState && (this.field.type === "radio" || this.field.type === "checkbox" || this.field.type === "select" || this.field.type === "cascader")) {
                if (this.field.options.dsEnabled) {
                    ...
                    let t = this.field.options.dsName
                      , r = this.field.options.dataSetName
                      , n = getDSByName(this.formConfig, t);
                    if (!!n && !r) {
                        let l = this.getGlobalDsv() || {}
                          , i = new Object({});
                        overwriteObj(i, l),
                        i.widgetName = this.field.options.name,
                        i.widgetKeyName = this.fieldKeyName;
                        let a = null;
                        try {
                            a = await runDataSourceRequest(n, i, this.getFormRef(), !1, this.$message),
                            this.loadOptions(a)
                        } catch (s) {
                            this.$message.error(s.message)
                        }
                    } else
                        !!n && !!r && !this.dataSetLoadedFlag && this.loadOptionItemsFromDataSet(t);
                    return
                }
                const o = this.getOptionData();
                if (!!o && o.hasOwnProperty(this.fieldKeyName)) {
                    e ? this.reloadOptions(o[this.fieldKeyName]) : this.loadOptions(o[this.fieldKeyName]);
                    return
                }
                this.field.type !== "cascader" && this.translateOptionItemsValue()
            }
        },
        translateOptionItemsValue() {
            let e = this.field.options.optionValueType;
            this.field.options.optionItems.forEach((o,t)=>{
                let r = o.value + "";
                e === "String" ? o.value = r : e === "Number" ? o.value = Number(r) : e === "Boolean" && (r.toLowerCase() === "false" || r === "0" ? o.value = !1 : r.toLowerCase() === "true" || r === "1" ? o.value = !0 : o.value = null)
            }
            )
        },
        loadOptionItemsFromDataSet(e) {
            if (this.designState || this.field.type !== "radio" && this.field.type !== "checkbox" && this.field.type !== "select" && this.field.type !== "cascader" || !this.field.options.dsEnabled || !this.field.options.dsName || !this.field.options.dataSetName || this.field.options.dsName !== e)
                return;
            const o = this.getDSResultCache()
              , t = this.field.options.dataSetName;
            !!o && !!o[e] && !!o[e][t] && (this.field.options.optionItems.splice(0, this.field.options.optionItems.length),
            this.loadOptions(o[e][t]))
        },
        refreshDefaultValue() {
        ...
        buildFieldRules() {
            if (!(!this.field.formItemFlag || this.field.options.hidden)) {
                ...
                this.field.options.validation) {
                    ...
                    FormValidators[e] ? this.rules.push({
                        validator: FormValidators[e],
                        trigger: ["blur", "change"],
                ...
                if (this.field.options.onValidate) {
                    let e = (o,t,r)=>new Function("rule","value","callback",this.field.options.onValidate).call(this, o, t, r);
                    this.rules.push({
                        validator: e,
                        trigger: ["blur", "change"],
                        label: this.field.options.label
        ...
        disableChangeValidate() {
            !this.rules || this.rules.forEach(e=>{
        ...
        disableOptionOfList(e, o) {
            !!e && e.length > 0 && e.forEach(t=>{
                t.value === o && (t.disabled = !0),
                t.children && Array.isArray(t.children) && this.disableOptionOfList(t.children, o)
            }
            )
        },
        enableOptionOfList(e, o) {
            !!e && e.length > 0 && e.forEach(t=>{
                t.value === o && (t.disabled = !1),
                t.children && Array.isArray(t.children) && this.enableOptionOfList(t.children, o)
            }
            )
        },
        emitFieldDataChange(e, o) {
            this.emit$("field-value-changed", [e, o]),
            this.broadcast("FieldWidget", "sync-field-value", [this.field.options.name, this.field.options.keyName, this.subFormName, this.subFormRowId, e, this.getObjectName()]),
            this.getFormRef().broadcast("FieldWidget", "calculate-formula", [e, this]),
            this.dispatch("VFormRender", "fieldChange", [this.field.options.name, e, o, this.subFormName, this.subFormRowIndex])
        },
        syncUpdateFormModel(e) {
            if (!this.designState)
                if (this.subFormItemFlag) {
                    let t = (this.formModel[this.subFormName] || [{}])[this.subFormRowIndex];
                    t && (t[this.fieldKeyName] = e)
                } else if (this.getObjectFieldFlag()) {
                    const o = this.getObjectModel();
                    o[this.fieldKeyName] = e
                } else
                    this.formModel[this.fieldKeyName] = e
        },
        handleChangeEvent(e) {
            this.designState || (this.syncUpdateFormModel(e),
            this.emitFieldDataChange(e, this.oldFieldValue),
            this.oldFieldValue = deepClone(e),
            this.dispatch("VFormRender", "fieldValidation", [this.getPropName()]))
        },
        handleFocusCustomEvent(e) {
            this.designState || (this.oldFieldValue = deepClone(this.fieldModel),
            this.field.options.onFocus && new Function("event",this.field.options.onFocus).call(this, e))
        },
        handleBlurCustomEvent(e) {
            this.designState || this.field.options.onBlur && new Function("event",this.field.options.onBlur).call(this, e)
        },
        handleInputCustomEvent(e) {
            this.designState || (this.syncUpdateFormModel(e),
            this.dispatch("VFormRender", "fieldValidation", [this.getPropName()]),
            this.field.options.onInput && new Function("value",this.field.options.onInput).call(this, e))
        },
        ...
        handleOnChange(e, o) {
            this.designState || this.field.options.onChange && new Function("value","oldValue",this.field.options.onChange).call(this, e, o)
        },
        handleOnChangeForSubForm(e, o, t, r) {
            this.designState || this.field.options.onChange && new Function("value","oldValue","subFormData","rowId",this.field.options.onChange).call(this, e, o, t, r)
        },
        ...
        remoteQuery(e) {
            this.designState || this.field.options.onRemoteQuery && new Function("keyword",this.field.options.onRemoteQuery).call(this, e)
        },
        getFormRef() {
        ...
        setValue(e, o=!1) {
            if (this.field.formItemFlag) {
                ...
                o || this.emitFieldDataChange(e, t)
            }
        },
        getValue() {
        ...
        getSelectedLabel() {},
        resetField(e=!1) {
            let o = this.field.options.defaultValue;
            this.setValue(o, e),
            this.$nextTick(()=>{}
            ),
            (this.field.type === "picture-upload" || this.field.type === "file-upload") && (this.$refs.fieldEditor && this.$refs.fieldEditor.clearFiles(),
            this.fileList.splice(0, this.fileList.length))
        },
        setWidgetOption(e, o) {
            this.field.options.hasOwnProperty(e) && (this.field.options[e] = o)
        },
        setReadonly(e) {
        ...
        setRequired(e) {
            ...
            !this.designState && !e && this.clearValidate()
        },
        clearValidate() {
            this.designState || this.getFormRef().getNativeForm().clearValidate(this.getPropName())
        },
        setLabel(e) {
        ...
        loadOptions(e) {
            this.field.options.optionItems = translateOptionItems(e, this.field.type, this.field.options.labelKey || "label", this.field.options.valueKey || "value")
        },
        reloadOptions(e) {
            this.field.options.optionItems = translateOptionItems(e, this.field.type, this.field.options.labelKey || "label", this.field.options.valueKey || "value")
        },
        ...
        removeCssClass(e) {
            if (!this.field.options.customClass)
                return;
            let o = -1;
            this.field.options.customClass.map((t,r)=>{
                t === e && (o = r)
            }
            ),
            o > -1 && this.field.options.customClass.splice(o, 1)
        }
    }
