  ...
  methods: {
    ...
    close() {
      ;(this.options.onDialogBeforeClose &&
        new Function('done', this.options.onDialogBeforeClose).call(this) ===
          !1) ||
        ((this.dialogVisible = !1), setTimeout(this.deleteWrapperNode, 150))
    },
    deleteWrapperNode() {
    ...
    handleBeforeClose(e) {
      if (this.options.onDialogBeforeClose) {
        let t = new Function('done', this.options.onDialogBeforeClose).call(
          this
        )
        return t === !1 ? t : e()
      }
    ...
    handleOpenedEvent() {
      this.options.onDialogOpened &&
        new Function(this.options.onDialogOpened).call(this)
    },
    handleCancelClick() {
